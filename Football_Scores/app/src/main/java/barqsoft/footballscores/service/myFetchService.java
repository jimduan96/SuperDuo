...
public class myFetchService extends IntentService
{
    ...
    private void getData (String timeFrame)
    {
        ...
        //Opening Connection
        try {
            // jd makeup URL fetch = new URL(fetch_build.toString());
            String jdtemp = "http://api.football-data.org/alpha/fixtures/?timeFrameStart=2015-03-01&timeFrameEnd=2015-03-05";// jd makeup
            URL fetch = new URL(jdtemp);// jd makeup
